    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          The invoice number is assigned automatically when you save. Totals are calculated on the server from line
          items.
        </p>
      </div>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-slate-800 bg-slate-950/40 px-4 py-3">
            ...
            <p className="mt-1 text-sm text-slate-400">
              Generated by the server when you create the invoice (for example INV-000001).
            </p>
          </div>
